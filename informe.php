...
<head>
  ...
  <!-- Prevenir parpadeo de tema (Zero FOUC) -->
  <script>
    (function() {
      try {
...
<body class="informe-page-body">
  ...
  <div class="lockscreen-overlay" id="admin-lockscreen" style="display: none;">
    <div class="lockscreen-card">
      ...
      <form id="lockscreen-form" onsubmit="return false;">
  ...
  <!-- BARRA DE HERRAMIENTAS FLOTANTE (Solo pantalla, se oculta al imprimir) -->
  <aside class="informe-toolbar-wrap no-print" aria-label="Herramientas del Informe">
    <div class="informe-toolbar">
      <div class="informe-toolbar-left">
        ...
        <!-- Filtros de vista rápida en pantalla -->
        <div class="informe-view-chips" role="tablist">
          <button class="informe-chip active" data-view="all">Informe Completo</button>
          <button class="informe-chip" data-view="padron">Solo Padrón</button>
          <button class="informe-chip" data-view="ordenanza">Anteproyecto</button>
        </div>
      </div>

      <div class="informe-toolbar-right">
        <!-- Toggle para ocultar fotos al imprimir o para ahorro de tinta -->
        <label class="informe-toggle-wrap" title="Activar o desactivar fotos en la tabla">
          <input type="checkbox" id="toggle-photos-chk" checked>
          <span>Fotos en tabla</span>
        </label>

        <!-- Botón de Modo Oscuro -->
        <button class="theme-toggle-btn" id="theme-toggle-btn" aria-label="Cambiar tema de color" title="Alternar tema claro/oscuro">
        ...
        <!-- Botón de Impresión / Guardar PDF Oficial A4 -->
        <button class="informe-btn-primary" id="btn-print-doc" title="Imprimir documento o exportar a formato PDF A4">
  ...
  <!-- CONTENEDOR DEL DOCUMENTO MEMBRETADO -->
  <div class="informe-container">
    <article class="informe-document" id="informe-documento">

      <!-- ENCABEZADO PROTOCOLAR / MEMBRETE MUNICIPAL -->
      <header class="informe-header">
        <div class="informe-header-top">
          <div class="informe-logo-block">
            <img src="assets/logo-sanjose.png" alt="Escudo de la Municipalidad de San José, Entre Ríos" class="informe-logo-img">
            <div class="informe-logo-text">
              <h2>Municipalidad de San José</h2>
              <p>Secretaría de Educación, Cultura y Turismo &bull; Entre Ríos</p>
            </div>
          </div>
          <div class="informe-badge-council">
            <span class="council-tag">H. Concejo Deliberante</span>
            <span class="council-period">Período Legislativo 2026</span>
          </div>
        </div>
      ...
      <!-- CUADRO DE METADATOS DEL EXPEDIENTE LEGISLATIVO -->
      <section class="informe-meta-box">
        <div>
          <div class="meta-field-label">Expediente HCD N°</div>
          <div class="meta-field-val">2026-PSJ-044-PROD</div>
        </div>
        <div>
          <div class="meta-field-label">Iniciador</div>
          <div class="meta-field-val">Secretaría de Educación, Cultura y Turismo &bull; D.E.M.</div>
        </div>
        <div>
          <div class="meta-field-label">Destinatario</div>
          <div class="meta-field-val">Honorable Concejo Deliberante (Cuerpo en Sesión)</div>
        </div>
        <div>
          <div class="meta-field-label">Fecha de Elevación</div>
          <div class="meta-field-val" id="informe-fecha-val">9 de Septiembre de 2026</div>
        </div>
        <div>
          <div class="meta-field-label">Objeto</div>
          <div class="meta-field-val">Declaración de Interés Municipal & Señalética Productiva</div>
        </div>
        <div>
      ...
      <section class="informe-sec" id="sec-fundamentos">
        <div class="informe-sec-header">
          ...
          <h3 class="sec-title">Fundamentos y Diagnóstico Estratégico</h3>
        </div>
        <p>
          La Ciudad de San José posee una rica tradición forjada a partir del arribo de los primeros colonos en 1857, manifestada hoy en una matriz productiva singular que combina agroindustria familiar, plantaciones de <strong>nuez pecán</strong> de vanguardia, <strong>licorería artesanal centenaria</strong>, apicultura de monte nativo, queserías de colonia, vitivinicultura emergente y una tradición inquebrantable de cuchillería y artesanías regionales en fibra de yatay.
        </p>
        <p>
        ...
        <p>
          La iniciativa <strong>«Hecho en San José: Mapa Productivo»</strong> responde a esta necesidad mediante una solución de <em>soberanía tecnológica</em>: implementada íntegramente sobre tecnologías de código abierto (<strong>Leaflet.js</strong> y <strong>OpenStreetMap</strong>), eximiendo al erario público municipal del pago de cánones o suscripciones de plataformas privadas y garantizando disponibilidad continua e interoperabilidad inmediata con el portal oficial <code>sanjose.tur.ar/hechoensanjose</code>.
        </p>
      </section>
      ...
      <section class="informe-sec" id="sec-indicadores">
        <div class="informe-sec-header">
          ...
          <h3 class="sec-title">Tablero de Indicadores del Programa</h3>
        </div>
        <div class="informe-stats-grid">
          <div class="informe-stat-card">
            <div class="informe-stat-val">11</div>
            <div class="informe-stat-lbl">Establecimientos Georreferenciados al 100%</div>
          </div>
          <div class="informe-stat-card">
            <div class="informe-stat-val">5</div>
            <div class="informe-stat-lbl">Rubros Estratégicos con Identidad de Origen</div>
          </div>
          <div class="informe-stat-card">
            <div class="informe-stat-val">4</div>
            <div class="informe-stat-lbl">Puntos de Venta Físicos (Góndolas Activas)</div>
          </div>
          <div class="informe-stat-card">
            <div class="informe-stat-val">$0</div>
            <div class="informe-stat-lbl">Costo Municipal en Licencias Tecnológicas</div>
          </div>
        </div>
      </section>
      ...
      <section class="informe-sec informe-avoid-break" id="sec-padron">
        <div class="informe-sec-header">
          ...
          <h3 class="sec-title">Padrón Oficial de Establecimientos Relevados</h3>
        </div>
        <p>
        ...
        <div class="informe-table-responsive">
      ...
      <section class="informe-sec informe-avoid-break" id="sec-gondolas">
        <div class="informe-sec-header">
          ...
          <h3 class="sec-title">Puntos de Venta del Programa «Góndolas Hecho en San José»</h3>
        </div>
        <p>
        ...
        <div class="informe-gondolas-grid">
          <div class="informe-gondola-card">
            <h4>1. Supermercado San José</h4>
            <p><strong>Ubicación:</strong> Av. Centenario 1240</p>
            <p><strong>Productos:</strong> Miel, nueces pecán envasadas, dulces artesanales y licores.</p>
          </div>
          <div class="informe-gondola-card">
            <h4>2. Autoservicio Colón</h4>
            <p><strong>Ubicación:</strong> Urquiza 850 (Zona Céntrica)</p>
            <p><strong>Productos:</strong> Conservas tradicionales, chacinados coloniales y alfajores.</p>
          </div>
          <div class="informe-gondola-card">
            <h4>3. Almacén de Sabores</h4>
            <p><strong>Ubicación:</strong> 9 de Julio 1420</p>
            <p><strong>Productos:</strong> Quesos de campo, vinos varietales y cerveza tirada en growlers.</p>
          </div>
          <div class="informe-gondola-card">
            <h4>4. Despensa El Molino</h4>
            <p><strong>Ubicación:</strong> Acceso Bastidas s/n (Ruta 130)</p>
            <p><strong>Productos:</strong> Cestería en palma yatay, souvenirs y recuerdos locales.</p>
          </div>
        </div>
      </section>
      ...
      <section class="informe-sec informe-avoid-break" id="sec-qr">
        <div class="informe-sec-header">
          ...
          <h3 class="sec-title">Verificación Digital & Acceso al Mapa en Vivo</h3>
        </div>
        <div class="informe-qr-card">
          <img src="assets/qr-plataforma.svg" alt="Código QR para escanear y acceder a la plataforma en vivo" class="informe-qr-img">
          <div class="informe-qr-info">
            <h4>Escaneo Directo para Concejales y Equipos Técnicos</h4>
            <p>
              El código QR adjunto permite acceder de forma instantánea desde cualquier dispositivo móvil al <strong>Mapa Productivo Interactivo en tiempo real</strong> y al Catálogo Digital de Negocios, comprobando la funcionalidad de los filtros por rubro, el centrado geográfico en Plaza Urquiza y los botones de contacto de WhatsApp.
            </p>
            <div class="informe-qr-link">
              URL Oficial de Acceso: <strong>https://ea00d009.github.io/productores-sanjose/</strong>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="informe-sec informe-avoid-break" id="sec-ordenanza">
        <div class="informe-sec-header">
          ...
          <h3 class="sec-title">Anteproyecto de Ordenanza Municipal Recomendado</h3>
        </div>
        ...
        <div class="informe-ordenanza-box">
          ...
          <div class="legal-recital">CONSIDERANDO:</div>
          <p class="legal-article">
      ...
      <section class="informe-sec informe-avoid-break" id="sec-firmas">
        ...
        <div class="informe-signatures">
          <div class="signature-block">
            <div class="sig-line"></div>
            <div class="sig-name">Lic. Eliana Zanini</div>
            <div class="sig-title">Secretaría de Educación, Cultura y Turismo<br>Municipalidad de San José</div>
          </div>
          <div class="signature-block">
            <div class="sig-line"></div>
            <div class="sig-name">Dr. Gustavo Bastián</div>
            <div class="sig-title">Presidente Municipal<br>Municipalidad de San José</div>
          </div>
          <div class="signature-block">
            <div class="sig-line"></div>
            <div class="sig-name">Mesa de Presidencia</div>
            <div class="sig-title">Honorable Concejo Deliberante<br>Ciudad de San José</div>
          </div>
        </div>
      </section>
  ...
  <!-- SCRIPT DE INTERACTIVIDAD DEL INFORME -->
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      // 1. Botón Imprimir / PDF
      ...
      // 2. Toggle Mostrar / Ocultar Fotografías en la tabla
      const togglePhotos = document.getElementById('toggle-photos-chk');
      const tableWrap = document.getElementById('tabla-productores-informe');
      if (togglePhotos && tableWrap) {
        togglePhotos.addEventListener('change', () => {
          if (togglePhotos.checked) {
            tableWrap.classList.remove('hide-photos');
          } else {
            tableWrap.classList.add('hide-photos');
          }
        });
      }

      // 3. Filtros de vista en pantalla (Chips)
      const chips = document.querySelectorAll('.informe-chip');
      const secFundamentos = document.getElementById('sec-fundamentos');
      const secIndicadores = document.getElementById('sec-indicadores');
      const secPadron = document.getElementById('sec-padron');
      const secGondolas = document.getElementById('sec-gondolas');
      const secQr = document.getElementById('sec-qr');
      const secOrdenanza = document.getElementById('sec-ordenanza');
      const secFirmas = document.getElementById('sec-firmas');
      ...
      chips.forEach(chip => {
        chip.addEventListener('click', () => {
          ...
          if (view === 'all') {
            [secFundamentos, secIndicadores, secPadron, secGondolas, secQr, secOrdenanza, secFirmas].forEach(s => {
              if (s) s.style.display = 'block';
            });
          } else if (view === 'padron') {
            if (secFundamentos) secFundamentos.style.display = 'none';
            if (secIndicadores) secIndicadores.style.display = 'block';
            if (secPadron) secPadron.style.display = 'block';
            if (secGondolas) secGondolas.style.display = 'block';
            if (secQr) secQr.style.display = 'block';
            if (secOrdenanza) secOrdenanza.style.display = 'none';
            if (secFirmas) secFirmas.style.display = 'block';
          } else if (view === 'ordenanza') {
            if (secFundamentos) secFundamentos.style.display = 'block';
            if (secIndicadores) secIndicadores.style.display = 'none';
            if (secPadron) secPadron.style.display = 'none';
            if (secGondolas) secGondolas.style.display = 'none';
            if (secQr) secQr.style.display = 'none';
            if (secOrdenanza) secOrdenanza.style.display = 'block';
            if (secFirmas) secFirmas.style.display = 'block';
          }
        });
      });

      // 4. Modo Oscuro / Claro en Informe
      ...
      // 5. Control de Acceso Restringido HCD (PIN 2706)
      ...
      const docContainer = document.querySelector('.informe-container');
      const toolbar = document.querySelector('.informe-toolbar-wrap');
      const lockForm = document.getElementById('lockscreen-form');
      const lockInput = document.getElementById('lockscreen-pin-input');
      const lockError = document.getElementById('lockscreen-pin-error');
      const lockCard = document.querySelector('.lockscreen-card');

      function verificarAutorizacion() {
        const auth = sessionStorage.getItem(SANJOSE_AUTH_KEY);
        if (auth !== SANJOSE_ADMIN_PIN) {
      ...
      // Manejar envío de PIN en pantalla de bloqueo
      if (lockForm) {
        lockForm.addEventListener('submit', (e) => {
          e.preventDefault();
          const valor = lockInput ? lockInput.value.trim() : '';
          if (valor === SANJOSE_ADMIN_PIN) {
            sessionStorage.setItem(SANJOSE_AUTH_KEY, SANJOSE_ADMIN_PIN);
            if (lockError) {
              lockError.style.color = '#10b981';
              lockError.textContent = 'Acceso concedido. Cargando informe...';
            }
            setTimeout(() => {
              verificarAutorizacion();
            }, 250);
            ...
            if (lockError) {
              lockError.style.color = '#ef4444';
              lockError.textContent = 'PIN incorrecto. Reintente.';
            }
            if (lockCard) {
      ...
      // Botón Bloquear / Salir en la barra de herramientas
